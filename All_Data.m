T_D = readtable('subj104_disney.xlsx', 'Range', 'B1:G41') % range covers all data(including both emotional and neutral)
T_mat_D=table2array(T_D);
res = T_mat_D

pairs = [[1 2] ;[3 4] ;[5 6]; [1 6] ;[2 4]; [3 5]]

dependency_all_pairs = zeros(6,3)
