...
In the end, we`ll have 40 files for each paradigm with the dimension of 9X7. Each row stands for each subject and variables are vent_number, Ab, Ac...(possible pairs). This matrices are allowing to run the script for dependency models in MATLAB.
